...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        gridBankMainAddWorker.add( wageLabel, 0, 5 );
    
        TextField wageAdd = new TextField();
        gridBankMainAddWorker.add(wageAdd, 1,5);
...
//                gridBankContinued.add( paid2, 3, 3 );
        ...
        btnBankAddWorkerSubmit.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                s2.addWorker(nameAdd.getText(), Integer.parseInt(ageAdd.getText()), Float.parseFloat( wageAdd.getText() ), idAdd.getText());
